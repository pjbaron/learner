"""
Test continual learning with 10 epochs per task (faster test).

Since learning stabilizes around epoch 10, this gives us the forgetting
measurement much faster while still being meaningful.
"""
...
network = FastMessyPerceptronNetwork(
    ...
    settling_iterations=60,  # Covers longest recurrent paths
    seed=42
).to(device)
...
n_epochs = 10  # Reduced from 15 since it stabilizes by epoch 10
